...
<footer class="page-footer font-small mdb-color pt-4" style="background:navy">
    <!--link rel="stylesheet" type="text/scss" href="/sass/social.sass"/-->
    ...
    <div class="container text-center text-md-left">
        ...
        <div class="row text-center text-md-left mt-3 pb-3">
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                <h6 class="text-uppercase mb-4 font-weight-bold" style="color: white">Happy Zone BD</h6>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <p style="color: white">
                    <i class="fas fa-home mr-3"></i> Mirpur, Dhaka</p>
                <p style="color: white">
                    <i class="fas fa-envelope mr-3"></i> https://www.facebook.com/happyzonebd365 </p>
                <p style="color: white">
                    <i class="fas fa-phone mr-3"></i> +880-1521329993</p>
                <p style="color: white">
                    <i class="fas fa-print mr-3"></i> +8801711488111</p>
            </div>
            <!-- Grid column -->
        ...
        <div class="row d-flex align-items-center">
            ...
            <!--div class="col-md-7 col-lg-8">
                ...
                <p class="text-center text-md-left">© 2020 Copyright:
                    <a href="https://rifatahmed034@gmail.com/" style="color: #1b1e21">
                        <strong>rifatahmed034@gmail.com</strong>
                    </a>
                </p>
            ...
            <script>
                $(function () {
                    let speed = 0.7;
                    let ease = Elastic.easeInOut.config(1.2, 0.5);
                    let demoDelay = 0;
                    ...
                    $(".social-icon").each(function () {
                        ...
                        if ($this.hasClass("w-gradient")) {
                            ...
                            tl.to(
                                $gradient.find("stop:nth-child(1)"),
                                speed,
                                {
                                    attr: { offset: "0%" },
                                    stopColor: "#FBBC6E",
                                ...
                                .to(
                                    $gradient.find("stop:nth-child(2)"),
                                    speed,
                                    {
                                        attr: { offset: "50%" },
                                        stopColor: "#D8456A",
                                ...
                                .to(
                                    $gradient.find("stop:nth-child(3)"),
                                    speed,
                                    {
                                        attr: { offset: "100%" },
                                        stopColor: "#4459A9",
